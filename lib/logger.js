...
module.exports = class WebergencyLogger extends Logger
{
    ...
    constructor( options )
    {
        ...
        this.#rpc_client = new Client_JSONRPC( 'wss://endpoint1.logger.webergency.com', { headers: { Authorization: 'Basic ' + Buffer.from( options.id + ':' + options.secret, 'utf8' ).toString('base64') }});
    ...
    #log( log )
    {
        ...
        this.#rpc_client.call( 'log', webergency_log ).catch( NOOP );
    }
}